"""Static weapon/talisman/ash-of-war item data for Nightreign, plus the filler-drop roll logic
that consumes it - split out of game_data.py (2026-09-03) since this is pure item lookup data with
no bearing on boss/nightlord/check-mechanics logic, which stayed in game_data.py.
"""
